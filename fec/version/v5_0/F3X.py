...
class Records(RecordsBase):
    def __init__(self):
        ...
        self.fields = [
            ...
            {'name': 'Transfers from Nonfederal Account (H3)', 'number': '36-18(a)'},
            ...
            {'name': 'Coordinated Expend made by Party Committees', 'number': '46-25.'},
            ...
            {'name': 'Total Disbursements', 'number': '54-31.'},
            {'name': 'Total Federal Disbursements', 'number': '55-32.'},
            {'name': 'Total Contributions', 'number': '56-33.'},
            {'name': 'Total Contribution Refunds', 'number': '57-34.'},
            {'name': 'Net Contributions', 'number': '58-35.'},
            {'name': 'Total Federal Operating Expenditures', 'number': '59-36.'},
            {'name': 'Offsets to Operating Expenditures', 'number': '60-37.'},
            {'name': 'Net Operating Expenditures', 'number': '61-38.'},
            ...
            {'name': 'Transfers from Nonfederal Account (H3)', 'number': '80-18(a)'},
            ...
            {'name': 'Coordinated Expend made by Party Committees', 'number': '90-25.'},
            ...
            {'name': 'Total Disbursements', 'number': '98-31.'},
            {'name': 'Total Federal Disbursements', 'number': '99-32.'},
            {'name': 'Total Contributions', 'number': '100-33.'},
            {'name': 'Total Contribution Refunds', 'number': '101-34.'},
            {'name': 'Net contributions', 'number': '102-35.'},
            {'name': 'Total Federal Operating Expenditures', 'number': '103-36.'},
            {'name': 'Offsets to Operating Expenditures', 'number': '104-37.'},
            {'name': 'Net Operating Expenditures', 'number': '105-38.'},
            {'name': 'NAME/TREASURER (as signed)', 'number': '106'},
            {'name': 'Signed', 'number': '107-'},
            {'name': 'Transfers from Non-Federal (Levin - H5)', 'number': '108-18(b)'},
            {'name': 'Total Non-Federal Transfers (18a+18b)', 'number': '109-18(c)'},
            {'name': 'Shared Federal Activity (H6) Fed Share', 'number': '110-30(a)i'},
            {'name': 'Shared Federal Activity (H6) Non-Fed', 'number': '111-30(a)ii'},
            {'name': 'Non-Allocable 100% Fed Election Activity', 'number': '112-30(b)'},
            {'name': 'Total Federal Election Activity', 'number': '113-30(c)'},
            {'name': 'Transfers from Non-Federal (Levin - H5)', 'number': '114-18(b)'},
            {'name': 'Total Non-Federal Transfers (18a+18b)', 'number': '115-18(c)'},
            {'name': 'Shared Federal Activity (H6) Fed Share', 'number': '116-30(a)i'},
            {'name': 'Shared Federal Activity (H6) Non-Fed', 'number': '117-30(a)ii'},
            {'name': 'Non-Allocable 100% Fed Election Activity', 'number': '118-30(b)'},
            {'name': 'Total Federal Election Activity', 'number': '119-30(c)'},
    ]
