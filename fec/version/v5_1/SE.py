...
class Records(RecordsBase):
    def __init__(self):
        self.fields = [
            ...
            {'name': 'as signed', 'number': '31-'},
            {'name': 'Signed', 'number': '32-'},
            {'name': 'Notarized', 'number': '33-'},
            {'name': 'Notary Commission Expires', 'number': '34-'},
            {'name': 'Notary', 'number': '35-'},
            ...
            {'name': 'ITEM ELECT CD', 'number': '42'},
            {'name': 'ITEM ELECT OTHER', 'number': '43'},
            {'name': 'CATEGORY CODE', 'number': '44'},
            {'name': 'TRANS CODE', 'number': '45'},
            {'name': 'CALENDAR YTD - OFFICE SOUGHT', 'number': '46'},
    ]
