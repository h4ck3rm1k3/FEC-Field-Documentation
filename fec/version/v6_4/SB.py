...
class Records(RecordsBase):
    def __init__(self):
        self.fields = [
            ...
            {'name': 'BENEFICIARY COMMITTEE FEC ID', 'number': '26'},
            {'name': 'BENEFICIARY COMMITTEE NAME', 'number': '27'},
            {'name': 'BENEFICIARY CANDIDATE FEC ID', 'number': '28'},
            {'name': 'BENEFICIARY CANDIDATE LAST NAME', 'number': '29'},
            {'name': 'BENEFICIARY CANDIDATE FIRST NAME', 'number': '30'},
            {'name': 'BENEFICIARY CANDIDATE MIDDLE NAME', 'number': '31'},
            {'name': 'BENEFICIARY CANDIDATE PREFIX', 'number': '32'},
            {'name': 'BENEFICIARY CANDIDATE SUFFIX', 'number': '33'},
            {'name': 'BENEFICIARY CANDIDATE OFFICE', 'number': '34'},
            {'name': 'BENEFICIARY CANDIDATE STATE', 'number': '35'},
            {'name': 'BENEFICIARY CANDIDATE DISTRICT', 'number': '36'},
