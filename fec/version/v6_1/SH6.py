...
class Records(RecordsBase):
    def __init__(self):
        ...
        self.fields = [
            ...
            {'name': 'Activity Is Voter Registration', 'number': '27-'},
            {'name': 'Activity GOTV', 'number': '28-'},
            {'name': 'Activity Is Voter ID', 'number': '29-'},
            {'name': 'Activity is Generic Campaign', 'number': '30-'},
            {'name': 'MEMO CODE', 'number': '31'},
            {'name': 'MEMO TEXT/DESCRIPTION', 'number': '32'},
    ]
